		...
		<div class="container mt-3">
			<div class="row">
				...
				<div class="col-sm-10">
					<div class="card">
						<div class="card-body">
							<h5 class="card-tittle">Data Pemesanan Tiket</h5>
							<hr>
							<table id="tabel-data">
                                ...
                                <tbody>
                                    ...
                                    $sql = mysqli_query($koneksi, "SELECT * FROM penumpang");
                                    foreach ($sql as $row) {
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $row["no_telp"]; ?></td>
                                            <td><?= $row["tambahan_bagasi"]; ?></td>
                                            <td><?= $row["kursi"]; ?></td>
                                            <td>
                                                <a href="hpspenumpang.php?id=<?= $row['id_penumpang']; ?>" onclick="return confirm ('Apakah Anda yakin akan Menghapus Data?')" class="btn btn-danger btn-sm">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                <tbody>
